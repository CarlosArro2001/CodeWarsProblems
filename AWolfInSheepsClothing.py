...
def warn_the_sheep(array):
    #checking if sheep is in front of me 
    if array[len(array)-1] =="wolf":
        ...
        for i in rev:
            if i == "wolf":
                print("Oi! Sheep number",rev.index(i)-1 ,"yo ass about to be jumped by a wolf.")
        #make i - 1 when output so that it wont start a 0
